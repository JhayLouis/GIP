        ...
        <div className="flex flex-col items-center justify-center text-center p-3">
          {applicant.photoFileData ? (
            <img
              ...
              alt="Applicant Photo"
              className="w-[2in] h-[2in] object-cover border border-gray-400"
            />
          ) : (
  ...
  return (
    <>
      ...
      {showImageModal && applicant.photoFileData && (
        <div
          className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-[60] no-print"
